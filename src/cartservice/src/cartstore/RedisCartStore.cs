...
public class RedisCartStore : ICartStore
{
    ...
    {
        Console.WriteLine($"AddItemAsync called with traceId={Tracer.CurrentSpan.Context.TraceId}, userId={userId}, productId={productId}, quantity={quantity}");
    ...
    {
        Console.WriteLine($"EmptyCartAsync called with traceId={Tracer.CurrentSpan.Context.TraceId}, userId={userId}");
    ...
    {
        Console.WriteLine($"GetCartAsync called with traceId={Tracer.CurrentSpan.Context.TraceId}, userId={userId}");
